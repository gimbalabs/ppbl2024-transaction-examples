...
cardano-cli conway transaction build \
  ...
  --out-file lock-tokens-slt2053-$ref.draft

cardano-cli conway transaction sign \
  --signing-key-file $sender_key \
  --testnet-magic 1 \
  --tx-body-file lock-tokens-slt2053-$ref.draft \
  --out-file lock-tokens-slt2053-$ref.signed

cardano-cli conway transaction submit \
  --tx-file lock-tokens-slt2053-$ref.signed \
  --testnet-magic 1
